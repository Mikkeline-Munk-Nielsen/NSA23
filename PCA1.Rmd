...
*Factor loadings er dem vi bruger, når vi skal fortolke indholdet af de komponenter, som vi trækker ud med PCA. Det skal vi arbejde med næste gang...*
...
- Factor loadings (som findes på bagrgund af egenvektorer og egenværdier) representerer korrelationen mellem hvert item i korrelationsmatricen med og komponenterne
