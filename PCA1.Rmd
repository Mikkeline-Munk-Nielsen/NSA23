...
Forestil jer, at vi har fem spørgsmål fra en survey på de danske gymnasier, der spørger ind til trivsel. Det første vi kunne gøre var at kombinere de fem spørgsmål til en simpel sumskala:

$$S = I_i + I_2+I_3+I_4+I_5$$
--

Her antager vi, at hver variabel bidrager lige meget til det underliggende fænomen, som vi forsøger at måle (trivsel).
---
# Skalakonstruktion
...
Hvorfor? Fordi kurset handler om data-mining, og fordi det er langt mere praktisk og intuitivt end CFA.
...
- Så snart vi kommer over tre dimensioner (variable i matricen), kan vi ikke længere tegne det.
...
```
Vi kan starte med at undersøge korrelationsmatricen:
```{r echo=FALSE}
