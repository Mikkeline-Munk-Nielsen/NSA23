...
- Hvis jeres komponenter ender med at loade negativt så en stigning på skalaen f.eks. betyder *mindre tillid* fremfor *mere* kan I bare vende skalaen:

```{r echo = T}
data$PC1 <-max(data$PC1, na.rm = TRUE) - data$PC1
```
